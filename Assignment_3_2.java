package assignment_3_2;
		...
		class skoda extends car        //Declaring skoda class which is the child class of car.
		{
			...
			public skoda(int maxSpeed1,int maxSpeed2)
			{
				...
				System.out.println("This is the constructor of Honda class."); 
			}
			...
			public void displaySpeed()
			{
				System.out.println("The speed of the Honda is "+this.maxSpeed);     //Using 'this' keyword with variable.
			}
			
		}


		public class Assignment_3_2     //Class declaration.
		{
			public static void main(String[] args)    //main function declaration. and because it is static, program execution starts from main function.
			{
				...
				System.out.println("Enter the two numbers,One denoting maximum speed of car and other denoting maximum speed of Honda");
